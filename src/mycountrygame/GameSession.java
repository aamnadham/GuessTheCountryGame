package mycountrygame;
	...
	public abstract class GameSession {
	    ...
	    protected Map<String, Country> countryMap; // Makes the map --> name is the key u get the values
	    
	    protected Set<String> guessedCountries = new HashSet<>(); // Sets don't have duplicates (unique element)
	    
	    protected Stack<String> guessHistory = new Stack<>(); // Shows the order of guesses (LIFO)
	    
	    protected LinkedList<DistanceRecord> closestGuesses = new LinkedList<>(); // frequent inserting at middle an start easy o use
